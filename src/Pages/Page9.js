    ...
    < div className={classes.pageContainer} >
      {
        props.gameState.userName ?
          <div className={classes.storyContainer} >
            ...
            <Typography className={classes.storyContent} variant='body1'> Wow, we really push that guy in the sunglasses, or "George", if that is his real name... He said he works for a local coffee shop and works with Jimmy. What? Didn't you know that Jimmy was a pretentious coffee person? Apparently, he was stealing coffee roasting tricks from a small coffee shop in Phinney Ridge. Jimmy had been working there...I thought he was a corporate Starbucks barista and loving it. Maybe the Starbucks Roastery is mad about him leaving. "George" said that Jimmy had messaged him to meet tonight, at 8, but Jimmy was already dead when he got there. He said he smelled a chocolate scent but saw no one else. </Typography>
