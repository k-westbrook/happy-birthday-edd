    ...
    <div className={classes.pageContainer}>
      <div className={classes.contentContainer}>
        <div>
          ...
          <Typography variant='body1' className={classes.text}>Tonight was supposed to be fun--it was Edd's birthday party. It was supposed to be about Edd. <br />BUT Jimmy "Hook" Baggins made it about him. They work together at the Starbucks Roastery. Amazing Baristas. I could never be anywhere near as talented as them.
